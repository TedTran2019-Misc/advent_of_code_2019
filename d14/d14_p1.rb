# Each loop passes in the dicts and the 'goal', e.g materials needed
# [1, FUEL] -> [2, AB], [3, BC], [4, CA]
# [2, AB] -> [3, A], [4, B]
# [3, A] -> 9 ORE
# Goal name is the key, goal number is amount needed
# Num_created is inside of the loop
# Keep running until until enough created!
...
p minimum_ore_for_reaction(a,	[1, 'FUEL'])
